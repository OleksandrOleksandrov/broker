...
async def run_research_agent(topic: str = None) -> str:
    ...
    # Wrap it to force reasoning_effort="none" on every call
    @wraps(original_create)
    async def custom_create(*args, **kwargs):
        kwargs["reasoning_effort"] = "none"
        return await original_create(*args, **kwargs)

    # Override the method on your client instance
    client.chat.completions.create = custom_create

    # Initialize your framework model with the patched client
